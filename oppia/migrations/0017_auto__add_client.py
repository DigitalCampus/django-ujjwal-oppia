...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Client'
        db.create_table(u'oppia_client', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('created_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('lastmodified_date', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ...
            ('marital_status', self.gf('django.db.models.fields.CharField')(max_length=3)),
            ('age', self.gf('django.db.models.fields.IntegerField')()),
            ('parity', self.gf('django.db.models.fields.CharField')(max_length=2)),
            ('life_stage', self.gf('django.db.models.fields.CharField')(max_length=17)),
        ))
        db.send_create_signal(u'oppia', ['Client'])


    def backwards(self, orm):
        # Deleting model 'Client'
        db.delete_table(u'oppia_client')
    ...
    models = {
        ...
        u'oppia.client': {
            ...
            'life_stage': ('django.db.models.fields.CharField', [], {'max_length': '17'}),
            'marital_status': ('django.db.models.fields.CharField', [], {'max_length': '3'}),
            'mobile_number': ('django.db.models.fields.IntegerField', [], {}),
            'name': ('django.db.models.fields.TextField', [], {}),
            'parity': ('django.db.models.fields.CharField', [], {'max_length': '2'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']"})
        },
        u'oppia.cohort': {
