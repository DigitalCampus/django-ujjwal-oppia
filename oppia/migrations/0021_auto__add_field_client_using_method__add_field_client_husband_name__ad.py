...
class Migration(SchemaMigration):
    def forwards(self, orm):
        # Adding field 'Client.using_method'
        db.add_column(u'oppia_client', 'using_method',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)

        # Adding field 'Client.husband_name'
        db.add_column(u'oppia_client', 'husband_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)

        # Adding field 'Client.youngest_child_age'
        db.add_column(u'oppia_client', 'youngest_child_age',
                      self.gf('django.db.models.fields.IntegerField')(default=0, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Client.using_method'
        db.delete_column(u'oppia_client', 'using_method')

        # Deleting field 'Client.husband_name'
        db.delete_column(u'oppia_client', 'husband_name')

        # Deleting field 'Client.youngest_child_age'
        db.delete_column(u'oppia_client', 'youngest_child_age')
    ...
    models = {
        ...
        u'oppia.client': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'lastmodified_date': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'life_stage': ('django.db.models.fields.CharField', [], {'max_length': '27'}),
            'marital_status': ('django.db.models.fields.CharField', [], {'max_length': '10'}),
            'mobile_number': ('django.db.models.fields.BigIntegerField', [], {}),
            'name': ('django.db.models.fields.TextField', [], {}),
            'parity': ('django.db.models.fields.CharField', [], {'max_length': '10'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']"}),
            'using_method': (
                'django.db.models.fields.CharField', [], {'default': "''", 'max_length': '100', 'blank': 'True'}),
            'youngest_child_age': ('django.db.models.fields.IntegerField', [], {'default': '0', 'blank': 'True'})
        },
        u'oppia.clienttracker': {
            'Meta': {'object_name': 'ClientTracker'},
            'client': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['oppia.Client']"}),
        ...
        u'oppia.cohort': {
            ...
            'schedule': ('django.db.models.fields.related.ForeignKey', [],
                         {'default': 'None', 'to': u"orm['oppia.Schedule']", 'null': 'True', 'blank': 'True'}),
            'start_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'})
        },
        u'oppia.course': {
            ...
            'badge_icon': (
                ...
                {'default': 'None', 'max_length': '100', 'blank': 'True'}),
        ...
        u'oppia.coursedownload': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'ip': (
                'django.db.models.fields.IPAddressField', [], {'default': 'None', 'max_length': '15', 'blank': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']"})
        },
        u'oppia.coursetag': {
        ...
        u'oppia.media': {
            ...
            'filename': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
            'filesize': (
                'django.db.models.fields.BigIntegerField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'media_length': (
        ...
        u'oppia.points': {
            ...
            'cohort': (
                'django.db.models.fields.related.ForeignKey', [], {'to': u"orm['oppia.Cohort']", 'null': 'True'}),
            'course': (
                'django.db.models.fields.related.ForeignKey', [], {'to': u"orm['oppia.Course']", 'null': 'True'}),
        ...
        u'oppia.tag': {
            ...
            'courses': ('django.db.models.fields.related.ManyToManyField', [],
                        {'to': u"orm['oppia.Course']", 'through': u"orm['oppia.CourseTag']", 'symmetrical': 'False'}),
            'created_by': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']"}),
            'created_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
            'description': (
                'django.db.models.fields.TextField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
            'highlight': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'icon': ('django.db.models.fields.files.FileField', [],
        ...
        u'oppia.tracker': {
            ...
            'course': ('django.db.models.fields.related.ForeignKey', [],
                       {'default': 'None', 'to': u"orm['oppia.Course']", 'null': 'True', 'blank': 'True'}),
            'data': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'digest': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'ip': ('django.db.models.fields.IPAddressField', [], {'max_length': '15'}),
            'lang': ('django.db.models.fields.CharField', [],
                     {'default': 'None', 'max_length': '10', 'null': 'True', 'blank': 'True'}),
            'section_title': (
                'django.db.models.fields.TextField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
