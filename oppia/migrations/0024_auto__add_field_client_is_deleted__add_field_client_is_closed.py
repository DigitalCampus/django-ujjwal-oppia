...
class Migration(SchemaMigration):
    def forwards(self, orm):
        # Adding field 'Client.is_deleted'
        db.add_column(u'oppia_client', 'is_deleted',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Client.is_closed'
        db.add_column(u'oppia_client', 'is_closed',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Client.is_deleted'
        db.delete_column(u'oppia_client', 'is_deleted')

        # Deleting field 'Client.is_closed'
        db.delete_column(u'oppia_client', 'is_closed')
