...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ClientTracker'
        db.create_table(u'oppia_clienttracker', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('start_time', self.gf('django.db.models.fields.DateTimeField')()),
            ('end_time', self.gf('django.db.models.fields.DateTimeField')()),
            ('client', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['oppia.Client'])),
        ))
        db.send_create_signal(u'oppia', ['ClientTracker'])


    def backwards(self, orm):
        # Deleting model 'ClientTracker'
        db.delete_table(u'oppia_clienttracker')
