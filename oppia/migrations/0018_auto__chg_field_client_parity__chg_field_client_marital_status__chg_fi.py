...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Client.parity'
        db.alter_column(u'oppia_client', 'parity', self.gf('django.db.models.fields.CharField')(max_length=10))

        # Changing field 'Client.marital_status'
        db.alter_column(u'oppia_client', 'marital_status', self.gf('django.db.models.fields.CharField')(max_length=10))

        # Changing field 'Client.gender'
        db.alter_column(u'oppia_client', 'gender', self.gf('django.db.models.fields.CharField')(max_length=10))

        # Changing field 'Client.life_stage'
        db.alter_column(u'oppia_client', 'life_stage', self.gf('django.db.models.fields.CharField')(max_length=27))

    def backwards(self, orm):

        # Changing field 'Client.parity'
        db.alter_column(u'oppia_client', 'parity', self.gf('django.db.models.fields.CharField')(max_length=2))

        # Changing field 'Client.marital_status'
        db.alter_column(u'oppia_client', 'marital_status', self.gf('django.db.models.fields.CharField')(max_length=3))

        # Changing field 'Client.gender'
        db.alter_column(u'oppia_client', 'gender', self.gf('django.db.models.fields.CharField')(max_length=6))

        # Changing field 'Client.life_stage'
        db.alter_column(u'oppia_client', 'life_stage', self.gf('django.db.models.fields.CharField')(max_length=17))
