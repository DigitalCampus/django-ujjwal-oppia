...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Client.mobile_number'
        db.alter_column(u'oppia_client', 'mobile_number', self.gf('django.db.models.fields.BigIntegerField')())

    def backwards(self, orm):

        # Changing field 'Client.mobile_number'
        db.alter_column(u'oppia_client', 'mobile_number', self.gf('django.db.models.fields.IntegerField')())
