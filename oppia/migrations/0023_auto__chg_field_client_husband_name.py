...
class Migration(SchemaMigration):
    def forwards(self, orm):
        # Changing field 'Cldelete all rows from table mysqlient.husband_name'
        db.alter_column(u'oppia_client', 'husband_name',
                        self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

    def backwards(self, orm):
        # Changing field 'Client.husband_name'
        db.alter_column(u'oppia_client', 'husband_name', self.gf('django.db.models.fields.CharField')(max_length=100))
