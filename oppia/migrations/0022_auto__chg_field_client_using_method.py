...
class Migration(SchemaMigration):
    def forwards(self, orm):
        # Changing field 'Client.using_method'
        db.alter_column(u'oppia_client', 'using_method',
                        self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

    def backwards(self, orm):
        # Changing field 'Client.using_method'
        db.alter_column(u'oppia_client', 'using_method', self.gf('django.db.models.fields.CharField')(max_length=100))
